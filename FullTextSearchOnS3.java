/*
 * The following code is open to all
 *aIt is merely an explanation of using Lucene with S3
 * and have been borrowed from their respective code samples
 * 1.  git clone https://github.com/EMCECS/ecs-samples.git
 * 2.  git clone https://github.com/macluq/helloLucene
 */
package FullTextSearchOnS3;
...
public class FullTextSearchOnS3 {
        ...
        private static void addDoc(IndexWriter w, String title, String isbn) throws IOException {
                ...
                putS3(isbn, doc.toString(), "title", title);
                w.addDocument(doc);
        }

        private static void putS3(String key, String content, String metaKey, String metaValue) {
                try {
