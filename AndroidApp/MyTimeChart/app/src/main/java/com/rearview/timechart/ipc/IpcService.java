package com.rearview.timechart.ipc;
...
import com.rearview.timechart.core.commandInfo;
...
public class IpcService {
  ...
  public void createConnection() {
    ...
    client = new IpcConnection(getSocketName(instance.ipcContext));
  }
  /**
   ...
   */
  private static boolean isGreaterThanIceCreamSandwich() {
   ...
   * @return true == yes, false == no
   */
  private static boolean isGreaterThanLollipop() {
  ...
  private static String getSocketName(Context context) {
    ...
    if (isGreaterThanLollipop())
      name = context.getFilesDir().getAbsolutePath() + "/" + "rvtcpcV";
    else
      name = "rvtcpcV";
