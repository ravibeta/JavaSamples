//
// Created by ravib on 12/26/2020.
//

#ifndef TIMECHART_CONNECTION_H
#define TIMECHART_CONNECTION_H
/**
 * @file Connection.h
...
namespace core {
   ...
   */
  class connection : com::rearview::timechart::core::base
  {
  private:
